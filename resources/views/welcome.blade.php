...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <header class="z-30">
    <img src="{{ asset('imagen/titulo1.gif') }}" alt="titulo" class="w-full">
    <div class="w-full">
...
<div class="flex mx-auto max-w-7xl  justify-10px md:justify-center space-x-2 bg-white mb-10 pb-10">
        ...
        <a class="texto" aria-label="Visit TrendyMinds YouTube" href="" target="_blank"><svg
            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" class="h-10 w-10">
